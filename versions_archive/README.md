...
| [v1.2.0_latest_yuanta_upgrade_and_responsive](./v1.2.0_latest_yuanta_upgrade_and_responsive/) | 第三階段 (最新旗艦版) | **元大證券風格防黑邊 K 線圖**、**實時國際時區與盤後交易追蹤**、**未開盤市場靜態無波動**、**非全螢幕比例自適應**、**全球大盤遮蔽修復**。 | **目前最新版 (Current)** |
